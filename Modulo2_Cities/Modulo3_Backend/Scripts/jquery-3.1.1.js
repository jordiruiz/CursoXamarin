...
var support = ***REMOVED******REMOVED***;
	...
	function DOMEval( code, doc ) ***REMOVED***
		doc = doc || document;
			...
			for ( name in options ) ***REMOVED***
				...
				***REMOVED***
				...
				if ( deep && copy && ( jQuery.isPlainObject( copy ) ||
					( copyIsArray = jQuery.isArray( copy ) ) ) ) ***REMOVED***
					...
					***REMOVED***
					...
					( function add( args ) ***REMOVED***
						jQuery.each( args, function( _, arg ) ***REMOVED***
							if ( jQuery.isFunction( arg ) ) ***REMOVED***
								if ( !options.unique || !self.has( arg ) ) ***REMOVED***
									list.push( arg );
								***REMOVED***
							***REMOVED*** else if ( arg && arg.length && jQuery.type( arg ) !== "string" ) ***REMOVED***
...
function adoptValue( value, resolve, reject ) ***REMOVED***
	var method;

	try ***REMOVED***

		// Check for promise aspect first to privilege synchronous behavior
		if ( value && jQuery.isFunction( ( method = value.promise ) ) ) ***REMOVED***
			method.call( value ).done( resolve ).fail( reject );

		// Other thenables
		***REMOVED*** else if ( value && jQuery.isFunction( ( method = value.then ) ) ) ***REMOVED***
							...
							var that = this,
								...
								mightThrow = function() ***REMOVED***
									...
									***REMOVED***
									...
									if ( jQuery.isFunction( then ) ) ***REMOVED***
	...
	when: function( singleValue ) ***REMOVED***
		...
		if ( remaining <= 1 ) ***REMOVED***
			...
			if ( master.state() === "pending" ||
				jQuery.isFunction( resolveValues[ i ] && resolveValues[ i ].then ) ) ***REMOVED***
...
function getAll( context, tag ) ***REMOVED***
	...
	***REMOVED***
	...
	if ( tag === undefined || tag && jQuery.nodeName( context, tag ) ) ***REMOVED***
...
function curCSS( elem, name, computed ) ***REMOVED***
	...
	if ( computed ) ***REMOVED***
		...
		***REMOVED***
		...
		if ( !support.pixelMarginRight() && rnumnonpx.test( ret ) && rmargin.test( name ) ) ***REMOVED***
...
function augmentWidthOrHeight( elem, name, extra, isBorderBox, styles ) ***REMOVED***
	...
	if ( extra === ( isBorderBox ? "border" : "content" ) ) ***REMOVED***
		i = 4;
...
function Animation( elem, properties, options ) ***REMOVED***
	...
	for ( ; index < length; index++ ) ***REMOVED***
		...
		if ( result ) ***REMOVED***
			if ( jQuery.isFunction( result.stop ) ) ***REMOVED***
...
jQuery.speed = function( speed, easing, fn ) ***REMOVED***
	...
	***REMOVED***;
	...
	if ( jQuery.fx.off || document.hidden ) ***REMOVED***
		opt.duration = 0;
...
jQuery.fx.stop = function() ***REMOVED***
	if ( window.cancelAnimationFrame ) ***REMOVED***
				...
				for ( ; i < max; i++ ) ***REMOVED***
					...
					if ( ( option.selected || i === index ) &&
							...
							( !option.parentNode.disabled ||
								!jQuery.nodeName( option.parentNode, "optgroup" ) ) ) ***REMOVED***
...
jQuery.fn.extend( ***REMOVED***
	offset: function( options ) ***REMOVED***
		...
		***REMOVED***
		...
		if ( rect.width || rect.height ) ***REMOVED***
			doc = elem.ownerDocument;
			win = getWindow( doc );
	...
	***REMOVED***,
	...
	position: function() ***REMOVED***
		...
		***REMOVED***
		...
		// Fixed elements are offset from window (parentOffset = ***REMOVED***top:0, left: 0***REMOVED***,
