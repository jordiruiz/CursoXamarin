...
var
	...
	***REMOVED***,
	...
	// JSON RegExp
	rvalidchars = /^[\],:***REMOVED******REMOVED***\s]*$/,
	rvalidbraces = /(?:^|:|,)(?:\s*\[)+/g,
	rvalidescape = /\\(?:["\\\/bfnrt]|u[\da-fA-F]***REMOVED***4***REMOVED***)/g,
	...
	***REMOVED***,
	...
	completed = function( event ) ***REMOVED***
...
jQuery.extend(***REMOVED***
	...
	***REMOVED***,
	...
	isPlainObject: function( obj ) ***REMOVED***
		...
		***REMOVED***
		...
		try ***REMOVED***
			...
			if ( obj.constructor &&
				...
				!core_hasOwn.call(obj.constructor.prototype, "isPrototypeOf") ) ***REMOVED***
				return false;
			***REMOVED***
		...
		***REMOVED***
		...
		if ( jQuery.support.ownLast ) ***REMOVED***
	...
	***REMOVED***,
	...
	parseJSON: function( data ) ***REMOVED***
...
function isArraylike( obj ) ***REMOVED***
	...
	if ( jQuery.isWindow( obj ) ) ***REMOVED***
		return false;
	***REMOVED***
		...
		***REMOVED***
		...
		if ( compare ) ***REMOVED***
			...
			if ( compare & 1 ||
				...
				if ( a === doc || contains(preferredDoc, a) ) ***REMOVED***
					return -1;
				***REMOVED***
				if ( b === doc || contains(preferredDoc, b) ) ***REMOVED***
					return 1;
				***REMOVED***
			...
			***REMOVED*** else ***REMOVED***
				while ( (elem = elem[ dir ]) ) ***REMOVED***
					if ( elem.nodeType === 1 || checkNonElements ) ***REMOVED***
						...
						if ( (cache = outerCache[ dir ]) && cache[0] === dirkey ) ***REMOVED***
							if ( (data = cache[1]) === true || data === cachedruns ) ***REMOVED***
								return data === true;
							***REMOVED***
						***REMOVED*** else ***REMOVED***
...
function createOptions( options ) ***REMOVED***
	...
	jQuery.each( options.match( core_rnotwhite ) || [], function( _, flag ) ***REMOVED***
		object[ flag ] = true;
	***REMOVED***);
	return object;
***REMOVED***
...
jQuery.support = (function( support ) ***REMOVED***
	...
	if ( !a || !a.style || !all.length ) ***REMOVED***
		return support;
	***REMOVED***
	...
	***REMOVED***
	...
	jQuery(function() ***REMOVED***
		...
		***REMOVED***
		...
		jQuery.swap( body, body.style.zoom != null ? ***REMOVED*** zoom: 1 ***REMOVED*** : ***REMOVED******REMOVED***, function() ***REMOVED***
			support.boxSizing = div.offsetWidth === 4;
		***REMOVED***);

		// Use window.getComputedStyle because jsdom on node.js will break without it.
		if ( window.getComputedStyle ) ***REMOVED***
			support.pixelPosition = ( window.getComputedStyle( div, null ) || ***REMOVED******REMOVED*** ).top !== "1%";
			support.boxSizingReliable = ( window.getComputedStyle( div, null ) || ***REMOVED*** width: "4px" ***REMOVED*** ).width === "4px";
			...
			support.reliableMarginRight =
				!parseFloat( ( window.getComputedStyle( marginDiv, null ) || ***REMOVED******REMOVED*** ).marginRight );
		***REMOVED***

		if ( typeof div.style.zoom !== core_strundefined ) ***REMOVED***
			// Support: IE<8
			...
			if ( support.inlineBlockNeedsLayout ) ***REMOVED***
...
var rbrace = /(?:\***REMOVED***[\s\S]*\***REMOVED***|\[[\s\S]*\])$/,
	rmultiDash = /([A-Z])/g;
...
function internalRemoveData( elem, name, pvt ) ***REMOVED***
	...
	***REMOVED***
	...
	/* jshint eqeqeq: false */
	***REMOVED*** else if ( jQuery.support.deleteExpando || cache != cache.window ) ***REMOVED***
		/* jshint eqeqeq: true */
		delete cache[ id ];
...
jQuery.extend(***REMOVED***
	...
	***REMOVED***,
	...
	acceptData: function( elem ) ***REMOVED***
		// Do not set data on non-element because it will not be cleared (#8335).
		if ( elem.nodeType && elem.nodeType !== 1 && elem.nodeType !== 9 ) ***REMOVED***
			return false;
		***REMOVED***
...
jQuery.extend(***REMOVED***
	...
	***REMOVED***,
	...
	attrHooks: ***REMOVED***
		type: ***REMOVED***
			set: function( elem, value ) ***REMOVED***
				if ( !jQuery.support.radioValue && value === "radio" && jQuery.nodeName(elem, "input") ) ***REMOVED***
...
// http://msdn.microsoft.com/en-us/library/ms536429%28VS.85%29.aspx
if ( !jQuery.support.hrefNormalized ) ***REMOVED***
...
if ( !jQuery.support.style ) ***REMOVED***
...
if ( !jQuery.support.enctype ) ***REMOVED***
		...
		***REMOVED***
		...
		while ( (cur = eventPath[i++]) && !event.isPropagationStopped() ) ***REMOVED***
			...
			***REMOVED***
			...
			if ( handle && jQuery.acceptData( cur ) && handle.apply && handle.apply( cur, data ) === false ) ***REMOVED***
	...
	***REMOVED*** :
	function( elem, type, handle ) ***REMOVED***
		...
		if ( elem.detachEvent ) ***REMOVED***
			...
			if ( typeof elem[ name ] === core_strundefined ) ***REMOVED***
				elem[ name ] = null;
			***REMOVED***
...
if ( !jQuery.support.submitBubbles ) ***REMOVED***
...
if ( !jQuery.support.changeBubbles ) ***REMOVED***
...
function winnow( elements, qualifier, not ) ***REMOVED***
	...
	***REMOVED***
	...
	if ( typeof qualifier === "string" ) ***REMOVED***
		if ( isSimple.test( qualifier ) ) ***REMOVED***
...
jQuery.fn.extend(***REMOVED***
	...
	***REMOVED***,
	...
	domManip: function( args, callback, allowIntersection ) ***REMOVED***
		...
		if ( isFunction || !( l <= 1 || typeof value !== "string" || jQuery.support.checkClone || !rchecked.test( value ) ) ) ***REMOVED***
...
function fixCloneNodeIssues( src, dest ) ***REMOVED***
	...
	***REMOVED***
	...
	if ( !jQuery.support.noCloneEvent && dest[ jQuery.expando ] ) ***REMOVED***
	...
	***REMOVED*** else if ( nodeName === "object" ) ***REMOVED***
		...
		***REMOVED***
		...
		if ( jQuery.support.html5Clone && ( src.innerHTML && !jQuery.trim(dest.innerHTML) ) ) ***REMOVED***
			dest.innerHTML = src.innerHTML;
		***REMOVED***

	***REMOVED*** else if ( nodeName === "input" && manipulation_rcheckableType.test( src.type ) ) ***REMOVED***
...
function fixDefaultChecked( elem ) ***REMOVED***
	if ( manipulation_rcheckableType.test( elem.type ) ) ***REMOVED***
...
jQuery.extend(***REMOVED***
	clone: function( elem, dataAndEvents, deepDataAndEvents ) ***REMOVED***
		...
		if ( jQuery.support.html5Clone || jQuery.isXMLDoc(elem) || !rnoshimcache.test( "<" + elem.nodeName + ">" ) ) ***REMOVED***
	...
	***REMOVED***,
	...
	buildFragment: function( elems, context, scripts, selection ) ***REMOVED***
			...
			if ( elem || elem === 0 ) ***REMOVED***
				...
				***REMOVED*** else ***REMOVED***
					...
					***REMOVED***
					...
					if ( !jQuery.support.leadingWhitespace && rleadingWhitespace.test( elem ) ) ***REMOVED***
						nodes.push( context.createTextNode( rleadingWhitespace.exec( elem )[0] ) );
					***REMOVED***

					// Remove IE's autoinserted <tbody> from table fragments
					if ( !jQuery.support.tbody ) ***REMOVED***
		...
		***REMOVED***
		...
		if ( !jQuery.support.appendChecked ) ***REMOVED***
				...
				if ( data ) ***REMOVED***
					...
					***REMOVED***
					...
					if ( cache[ id ] ) ***REMOVED***
						...
						***REMOVED*** else if ( typeof elem.removeAttribute !== core_strundefined ) ***REMOVED***
...
var iframe, getStyles, curCSS,
	...
	elemdisplay = ***REMOVED*** BODY: "block" ***REMOVED***,
		...
		***REMOVED***
		...
		if ( value !== undefined ) ***REMOVED***
			...
			***REMOVED***
			...
			if ( value == null || type === "number" && isNaN( value ) ) ***REMOVED***
				return;
			***REMOVED***
			...
			***REMOVED***
			...
			if ( !jQuery.support.clearCloneStyle && value === "" && name.indexOf("background") === 0 ) ***REMOVED***
				style[ name ] = "inherit";
			***REMOVED***
...
if ( !jQuery.support.opacity ) ***REMOVED***
...
jQuery(function() ***REMOVED***
	if ( !jQuery.support.reliableMarginRight ) ***REMOVED***
		jQuery.cssHooks.marginRight = ***REMOVED***
			get: function( elem, computed ) ***REMOVED***
				if ( computed ) ***REMOVED***
					// WebKit Bug 13343 - getComputedStyle returns wrong value for margin-right
...
var xhrCallbacks, xhrSupported,
	...
	xhrOnUnloadAbort = window.ActiveXObject && function() ***REMOVED***
		// Abort all pending requests
		var key;
		for ( key in xhrCallbacks ) ***REMOVED***
...
if ( xhrSupported ) ***REMOVED***
	...
	jQuery.ajaxTransport(function( s ) ***REMOVED***
		// Cross domain only allowed if supported through XMLHttpRequest
		if ( !s.crossDomain || jQuery.support.cors ) ***REMOVED***
			...
			return ***REMOVED***
				send: function( headers, complete ) ***REMOVED***
					...
					***REMOVED***
					...
					if ( s.xhrFields ) ***REMOVED***
						for ( i in s.xhrFields ) ***REMOVED***
							xhr[ i ] = s.xhrFields[ i ];
						***REMOVED***
					***REMOVED***

					// Override mime type if needed
					if ( s.mimeType && xhr.overrideMimeType ) ***REMOVED***
					...
					***REMOVED***
					...
					if ( !s.crossDomain && !headers["X-Requested-With"] ) ***REMOVED***
							...
							if ( callback && ( isAbort || xhr.readyState === 4 ) ) ***REMOVED***
								...
								***REMOVED*** else ***REMOVED***
									...
									***REMOVED***
									...
									if ( !status && s.isLocal && !s.crossDomain ) ***REMOVED***
								...
								***REMOVED***
							***REMOVED***
						***REMOVED*** catch( firefoxAccessException ) ***REMOVED***
							if ( !isAbort ) ***REMOVED***
...
function defaultPrefilter( elem, props, opts ) ***REMOVED***
	...
	***REMOVED***
	...
	if ( elem.nodeType === 1 && ( "height" in props || "width" in props ) ) ***REMOVED***
		...
		if ( jQuery.css( elem, "display" ) === "inline" &&
			...
			if ( !jQuery.support.inlineBlockNeedsLayout || css_defaultDisplay( elem.nodeName ) === "inline" ) ***REMOVED***
	...
	***REMOVED***
	...
	if ( opts.overflow ) ***REMOVED***
		...
		if ( !jQuery.support.shrinkWrapBlocks ) ***REMOVED***
			anim.always(function() ***REMOVED***
...
jQuery.fx.timer = function( timer ) ***REMOVED***
	if ( timer() && jQuery.timers.push( timer ) ) ***REMOVED***
		jQuery.fx.start();
	***REMOVED***
***REMOVED***;
	...
	setOffset: function( elem, options, i ) ***REMOVED***
		...
		***REMOVED***
		...
		var curElem = jQuery( elem ),
			...
			props = ***REMOVED******REMOVED***, curPosition = ***REMOVED******REMOVED***, curTop, curLeft;
...
jQuery.fn.extend(***REMOVED***
	...
	position: function() ***REMOVED***
		...
		***REMOVED***
		...
		// fixed elements are offset from window (parentOffset = ***REMOVED***top:0, left: 0***REMOVED***, because it is it's only offset parent
...
***REMOVED*** else ***REMOVED***
	...
	if ( typeof define === "function" && define.amd ) ***REMOVED***
		define( "jquery", [], function () ***REMOVED*** return jQuery; ***REMOVED*** );
	***REMOVED***
***REMOVED***
