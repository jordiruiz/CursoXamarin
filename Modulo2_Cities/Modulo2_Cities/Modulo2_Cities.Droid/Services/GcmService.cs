...
namespace CursoXamarin.Droid.Services
{
    ...
    public class GcmService : GcmServiceBase
    {
        ...
        protected override void OnRegistered(Context context, string registrationId)
        {
            ...
            var push = _cityService.Client.GetPush();
        ...
        protected override void OnMessage(Context context, Intent intent)
        {
            ...
            {
                CreateNotification("Nuevo XamagramItem!", "XamagramItem: " + message);
                return;
            }
            ...
            {
                CreateNotification("Nuevo mensaje!", msg2);
                return;
            }
